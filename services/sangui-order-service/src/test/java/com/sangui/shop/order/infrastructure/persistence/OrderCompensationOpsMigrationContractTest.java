...
class OrderCompensationOpsMigrationContractTest {

    private static final String MIGRATION_RESOURCE = "db/migration/V4__add_order_compensation_ops_columns.sql";

    @Test
    void orderCompensationOpsMigrationAddsLatestCompensationColumns() throws IOException {
