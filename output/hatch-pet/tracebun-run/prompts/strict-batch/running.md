This is a strict sprite-strip generation request for hatch-pet.
...
Create a single horizontal sprite strip for the Codex app digital pet `tracebun` in the state `running`.
